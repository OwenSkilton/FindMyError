...
const RenderRedhatArticleItem = ({crawledItem, user}) => {
    ...
    return (
        <div className={"crawler-singular-result"}>
            ...
            <div className={"crawler-result-inner-content"}>
                ...
                <div className={"crawler-article-brief"}>
                    <p style={{fontWeight: "bold"}}>Brief: </p>
                    <p className={"crawler-brief-content"}>{crawledItem.data.articleBrief}</p>
                </div>
...
export default RenderRedhatArticleItem;
